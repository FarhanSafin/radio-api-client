    ...
    if(isLoading){
      ...
      <table className="table w-full">
        ...
        <tbody>
        {
            ...
            <td>
        {
            <label onClick={() => handleDelete(radio._id)} className="btn btn-outline btn-error"><svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
